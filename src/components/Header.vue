                            ...
                            <div v-if="showResources" class="hidden md:block absolute z-10 top-full inset-x-0 transform shadow-lg bg-gray-200">
                                ...
                                <div class="bg-yellow-400">
                                    <div class="max-w-7xl mx-auto space-y-6 px-4 py-5 sm:flex sm:space-y-0 sm:space-x-10 sm:px-6 lg:px-8">
                                        ...
                                        <div class="flow-root">
                                            <a @click="openValidators" href="javascript://" class="-m-3 p-3 flex items-center rounded-md text-base font-medium text-gray-900 hover:bg-gray-100">
                                                ...
                                                <span class="ml-3">Validators</span>
                                            </a>
                                        </div>
