            ...
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                <div class="space-y-8 xl:col-span-1">
                    ...
                    <p class="text-gray-500 text-base">
                        <strong>Smart Bitcoin Info Center</strong> is a FREE portal providing SBCH stakeholders with the complete suite of tools and resources they'll need to <strong>work smarter</strong> and not harder.
                    </p>
                    ...
                    <div class="flex space-x-6">
                        ...
                        <a href="https://twitter.com/ShomariPrince" target="_blank" class="text-gray-400 hover:text-gray-500">
                        ...
                        <a href="https://gitlab.com/bchplease/sbch-info" target="_blank" class="text-gray-400 hover:text-gray-500">
                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        ...
                        <div class="mt-12 md:mt-0">
                            ...
                            <ul role="list" class="mt-4 space-y-4">
                                ...
                                <li>
                                    <a href="http://flipstarter.smartbch.org/" target="_blank" class="text-base text-gray-500 hover:text-gray-900">
                                        Origin Flipstarter
                                    </a>
                                </li>
